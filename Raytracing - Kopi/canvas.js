/***************************************************************
        ...
        function getX1PositionOfBox(name) {
            let index = lines.indexOf(name);
            if(index != -1) {
                return boxesx1[index]
            } else {
                return "does not exist"
            }
        }
        ...
        function getX2PositionOfBox(name) {
            let index = lines.indexOf(name);
            if(index != -1) {
                return boxesx2[index]
            } else {
                return "does not exist"
            }
        }

        function setX1PositionOfBox(name, setTo) {
            let index = lines.indexOf(name);
            if(index != -1) {
                boxesx1[index] = setTo
                return "done"
        ...
        function setY1PositionOfBox(name, setTo) {
            let index = lines.indexOf(name);
            if(index != -1) {
                boxesy1[index] = setTo
                return "done"
        ...
        function setX2PositionOfBox(name, setTo) {
            let index = lines.indexOf(name);
            if(index != -1) {
                boxesx2[index] = setTo
                return "done"
        ...
        function setY2PositionOfBox(name, setTo) {
            let index = lines.indexOf(name);
            if(index != -1) {
                boxesy[index] = setTo
                return "done"
