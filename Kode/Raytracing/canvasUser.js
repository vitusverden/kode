...
var lightsourceX = 100;
var lightsourceY = 200;
var points = [];
function update() {
...
lightsourceY + 4, lightsourceX + 5,]
    ...
    for (let i = 0; i < points.length; i += 2) {
		...
		if(intersects(lightsourceX, lightsourceY, x, y, getX1PositionOfLine("a"), getY1PositionOfLine("a"), getX2PositionOfLine("a"), getY2PositionOfLine("a"))) {
